...
public class TarefaContants {
    public static final TarefaRequestDto REQUEST_VALIDO = new TarefaRequestDto("Passear com o cachorro", "Levar o cachorro para passear antes do anoitecer", false, PrioridadeEnum.MEDIA);
    ...
    public static final TarefaRequestDto REQUEST_NULL = new TarefaRequestDto(null, null, null, null);

    public static final Tarefa TAREFA_VALIDO_01 = new TarefaMapper().toTarefa(REQUEST_VALIDO);
    public static final Tarefa TAREFA_VALIDO_02 = Tarefa.builder()
    ...
    public static final List<Tarefa> LISTA_TAREFAS = List.of(TAREFA_VALIDO_01, TAREFA_VALIDO_02, TAREFA_VALIDO_03);
    public static final List<Tarefa> LISTA_TAREFAS_FILTRADA = List.of(LISTA_TAREFAS.stream().findFirst().get());

    public static final TarefaResponseDto RESPONSE_VALIDO = new TarefaMapper().toDto(TAREFA_VALIDO_01);
}
